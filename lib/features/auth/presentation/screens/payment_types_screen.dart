...
class PaymentTypesScreen extends StatefulWidget {
  ...
  const PaymentTypesScreen({super.key, this.mode = 'transfer'});
  @override
...
class _PaymentTypesScreenState extends State<PaymentTypesScreen> {
  ...
  Widget build(BuildContext context) {
    final banks = <_PaymentOption>[
      _PaymentOption('Meezan Bank', 'assets/images/logo_meezan.png'),
      _PaymentOption('Jazz Cash Wallet', 'assets/images/logo_jazzcash.webp'),
      _PaymentOption('EasyPaisa-Telenor Bank', 'assets/images/logo_easy.jpg'),
      _PaymentOption('HBL KONNECT', 'assets/images/logo_hbl.png'),
      _PaymentOption('Bank Al-Habib', 'assets/images/logo_habib.webp'),
      _PaymentOption('UBL', 'assets/images/logo_ubl.png'),
      _PaymentOption('Bank Alfalah', 'assets/images/logo_alfala.png'),
      _PaymentOption('Allied Bank', 'assets/images/logo_allied.webp'),
    ];
...
class _PaymentOption {
  final String title;
  final String asset;
  _PaymentOption(this.title, this.asset);
}
